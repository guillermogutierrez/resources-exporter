...
public class WikiADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "wiki_page/";
	}

	@Override
	public String getExportItem() {

		return "adt_wiki_page_entry";
	}
	...
	protected String adtClassName = "com.liferay.wiki.model.WikiPage";
}

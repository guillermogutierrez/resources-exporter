...
public class RSSADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "rss_feed/";
	}

	@Override
	public String getExportItem() {

		return "adt_rss_entry";
	}
	...
	protected String adtClassName = "com.liferay.rss.web.util.RSSFeed";
}

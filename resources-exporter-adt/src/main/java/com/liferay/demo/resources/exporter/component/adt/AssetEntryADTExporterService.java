...
public class AssetEntryADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "asset_entry/";
	}

	@Override
	public String getExportItem() {

		return "adt_asset_entry";
	}
	...
	protected String adtClassName = "com.liferay.asset.kernel.model.AssetEntry";

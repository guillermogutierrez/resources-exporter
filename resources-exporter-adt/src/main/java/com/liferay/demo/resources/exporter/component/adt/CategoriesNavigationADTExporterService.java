...
public class CategoriesNavigationADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "asset_category/";
	}

	@Override
	public String getExportItem() {

		return "adt_category_entry";
	}
	...
	protected String adtClassName = "com.liferay.asset.kernel.model.AssetCategory";
}

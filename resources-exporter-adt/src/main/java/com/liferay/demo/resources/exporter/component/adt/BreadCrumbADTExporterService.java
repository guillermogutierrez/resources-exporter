...
public class BreadCrumbADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "bread_crumb/";
	}

	@Override
	public String getExportItem() {

		return "adt_breadcrumb_entry";
	}
	...
	protected String adtClassName = "com.liferay.portal.kernel.servlet.taglib.ui.BreadcrumbEntry";
}

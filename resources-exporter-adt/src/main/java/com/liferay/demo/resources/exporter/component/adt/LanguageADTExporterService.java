...
public class LanguageADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "language_entry/";
	}

	@Override
	public String getExportItem() {

		return "adt_language_entry";
	}
	...
	protected String adtClassName = "com.liferay.portal.kernel.servlet.taglib.ui.LanguageEntry";
}

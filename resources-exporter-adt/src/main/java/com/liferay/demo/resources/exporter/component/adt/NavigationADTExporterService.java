...
public class NavigationADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "site_navigation/";
	}

	@Override
	public String getExportItem() {

		return "adt_navitem_entry";
	}
	...
	protected String adtClassName = "com.liferay.portal.kernel.theme.NavItem";
}

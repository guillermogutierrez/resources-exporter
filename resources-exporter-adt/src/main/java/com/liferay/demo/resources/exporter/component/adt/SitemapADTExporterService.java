...
public class SitemapADTExporterService extends ADTExporterBaseService {
	...
	public String getPathName() {
		...
		return super.getPathName() + "site_map/";
	}

	@Override
	public String getExportItem() {

		return "adt_site_map_entry";
	}
	...
	protected String adtClassName = "com.liferay.portal.kernel.model.LayoutSet";
}
